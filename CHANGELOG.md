...
### Fixed
- Fixed disk explorer list overflowing past terminal bounds
- Enabled full-screen mode for proper UI containment
- Made viewport size dynamic based on terminal height (was fixed at 20 items)
- Arrow keys and vim navigation now properly scroll through all items
